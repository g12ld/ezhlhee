...
#editorUndoBar{
  --csstools-light-dark-toggle--3:var(--csstools-color-scheme--light) #FFFFFF;
  --text-primary-color:var(--csstools-light-dark-toggle--3, #0D2224);

  --message-bar-icon:url(images/messageBar_info.svg);
  --csstools-light-dark-toggle--4:var(--csstools-color-scheme--light) #3BBBC2;
  --message-bar-icon-color:var(--csstools-light-dark-toggle--4, #15B5B0);
  --csstools-light-dark-toggle--5:var(--csstools-color-scheme--light) #0D2224;
  --message-bar-bg-color:var(--csstools-light-dark-toggle--5, #FFFFFF);
  ...
  --csstools-light-dark-toggle--10:var(--csstools-color-scheme--light) #3BBBC2;

  --undo-button-border:1px solid var(--csstools-light-dark-toggle--10, #15B5B0);
...
#editorUndoBar{
  --text-primary-color:light-dark(#0D2224, #FFFFFF);
  --message-bar-icon-color:light-dark(#15B5B0, #3BBBC2);
  --message-bar-bg-color:light-dark(#FFFFFF, #0D2224);
}
}
...
#editorUndoBar{
  ...
  --undo-button-border:1px solid light-dark(#15B5B0, #3BBBC2);
}
}
...
.dialog{
  --csstools-light-dark-toggle--11:var(--csstools-color-scheme--light) #0D2224;
  --dialog-bg-color:var(--csstools-light-dark-toggle--11, white);
  --csstools-light-dark-toggle--12:var(--csstools-color-scheme--light) #0D2224;
  --dialog-border-color:var(--csstools-light-dark-toggle--12, white);
  --csstools-light-dark-toggle--13:var(--csstools-color-scheme--light) #0D2224;
  --dialog-shadow:0 2px 14px 0 var(--csstools-light-dark-toggle--13, rgb(58 57 68 / 0.2));
  --csstools-light-dark-toggle--14:var(--csstools-color-scheme--light) #FFFFFF;
  --text-primary-color:var(--csstools-light-dark-toggle--14, #0D2224);
  --csstools-light-dark-toggle--15:var(--csstools-color-scheme--light) #555555;
  --text-secondary-color:var(--csstools-light-dark-toggle--15, #555555);
  --hover-filter:brightness(0.9);
  --csstools-light-dark-toggle--16:var(--csstools-color-scheme--light) #3BBBC2;
  --link-fg-color:var(--csstools-light-dark-toggle--16, #15B5B0);
  --csstools-light-dark-toggle--17:var(--csstools-color-scheme--light) #3BBBC2;
  --link-hover-fg-color:var(--csstools-light-dark-toggle--17, #0D2224);
  --csstools-light-dark-toggle--18:var(--csstools-color-scheme--light) #555555;
  --separator-color:var(--csstools-light-dark-toggle--18, #FFFFFF);

  --textarea-border-color:#555555;
  --csstools-light-dark-toggle--19:var(--csstools-color-scheme--light) #0D2224;
  --textarea-bg-color:var(--csstools-light-dark-toggle--19, white);
  --textarea-fg-color:var(--text-secondary-color);

  --csstools-light-dark-toggle--20:var(--csstools-color-scheme--light) #0D2224;

  --radio-bg-color:var(--csstools-light-dark-toggle--20, #FFFFFF);
  --csstools-light-dark-toggle--21:var(--csstools-color-scheme--light) #0D2224;
  --radio-checked-bg-color:var(--csstools-light-dark-toggle--21, #FFFFFF);
  --radio-border-color:#555555;
  --csstools-light-dark-toggle--22:var(--csstools-color-scheme--light) #3BBBC2;
  --radio-checked-border-color:var(--csstools-light-dark-toggle--22, #15B5B0);
  ...
  --csstools-light-dark-toggle--26:var(--csstools-color-scheme--light) #3BBBC2;

  --button-primary-bg-color:var(--csstools-light-dark-toggle--26, #15B5B0);
  --csstools-light-dark-toggle--27:var(--csstools-color-scheme--light) #0D2224;
  --button-primary-fg-color:var(--csstools-light-dark-toggle--27, #FFFFFF);
  --button-primary-border-color:var(--button-primary-bg-color);
  --csstools-light-dark-toggle--28:var(--csstools-color-scheme--light) #FFFFFF;
  --button-primary-active-bg-color:var(--csstools-light-dark-toggle--28, #0D2224);
  --button-primary-active-fg-color:var(--button-primary-fg-color);
  --button-primary-active-border-color:var(--button-primary-active-bg-color);
  --csstools-light-dark-toggle--29:var(--csstools-color-scheme--light) #3BBBC2;
  --button-primary-hover-bg-color:var(--csstools-light-dark-toggle--29, #0D2224);
  ...
  --csstools-light-dark-toggle--30:var(--csstools-color-scheme--light) #0D2224;
...
@supports (color: light-dark(red, red)){
.dialog{
  --dialog-bg-color:light-dark(white, #0D2224);
  --dialog-border-color:light-dark(white, #0D2224);
}
}

@supports (color: light-dark(red, red)) and (color: rgb(0 0 0 / 0)){
.dialog{
  --dialog-shadow:0 2px 14px 0 light-dark(rgb(58 57 68 / 0.2), #0D2224);
}
}
...
.dialog{
  --text-primary-color:light-dark(#0D2224, #FFFFFF);
  --text-secondary-color:light-dark(#555555, #555555);
  --link-fg-color:light-dark(#15B5B0, #3BBBC2);
  --link-hover-fg-color:light-dark(#0D2224, #3BBBC2);
  --separator-color:light-dark(#FFFFFF, #555555);
  --textarea-bg-color:light-dark(white, #0D2224);

  --radio-bg-color:light-dark(#FFFFFF, #0D2224);
  --radio-checked-bg-color:light-dark(#FFFFFF, #0D2224);
  --radio-checked-border-color:light-dark(#15B5B0, #3BBBC2);
}
}
...
.dialog{
  ...
  --button-primary-bg-color:light-dark(#15B5B0, #3BBBC2);
  --button-primary-fg-color:light-dark(#FFFFFF, #0D2224);
  --button-primary-active-bg-color:light-dark(#0D2224, #FFFFFF);
  --button-primary-hover-bg-color:light-dark(#0D2224, #3BBBC2);

  --input-text-bg-color:light-dark(white, #0D2224);
}
}
...
:is(.dialog .mainContainer) .messageBar{
      --csstools-light-dark-toggle--31:var(--csstools-color-scheme--light) #0D2224;
      --message-bar-bg-color:var(--csstools-light-dark-toggle--31, #FFFFFF);
      --csstools-light-dark-toggle--32:var(--csstools-color-scheme--light) #FFFFFF;
      --message-bar-fg-color:var(--csstools-light-dark-toggle--32, #0D2224);
      ...
      --csstools-light-dark-toggle--34:var(--csstools-color-scheme--light) #3BBBC2;
      --message-bar-icon-color:var(--csstools-light-dark-toggle--34, #15B5B0);
    }

@supports (color: light-dark(red, red)){
:is(.dialog .mainContainer) .messageBar{
      --message-bar-bg-color:light-dark(#FFFFFF, #0D2224);
      --message-bar-fg-color:light-dark(#0D2224, #FFFFFF);
    }
}
...
.annotationLayer{
  ...
  --annotation-unfocused-field-background:url("data:image/svg+xml;charset=UTF-8,<svg width='1px' height='1px' xmlns='http://www.w3.org/2000/svg'><rect width='100%' height='100%' style='fill:rgba(13,34,36,0.13);'/></svg>");
...
:root{
  --xfa-unfocused-field-background:url("data:image/svg+xml;charset=UTF-8,<svg width='1px' height='1px' xmlns='http://www.w3.org/2000/svg'><rect width='100%' height='100%' style='fill:rgba(13,34,36,0.13);'/></svg>");
...
.toggle-button{
  ...
  --csstools-light-dark-toggle--35:var(--csstools-color-scheme--light) #3BBBC2;
  --color-accent-primary:var(--csstools-light-dark-toggle--35, #15B5B0);
  --csstools-light-dark-toggle--36:var(--csstools-color-scheme--light) #3BBBC2;
  --color-accent-primary-hover:var(--csstools-light-dark-toggle--36, #0D2224);
  --csstools-light-dark-toggle--37:var(--csstools-color-scheme--light) #FFFFFF;
  --color-accent-primary-active:var(--csstools-light-dark-toggle--37, #0D2224);
  --border-radius-circle:9999px;
  --border-width:1px;
  --size-item-small:16px;
  --size-item-large:32px;
  --csstools-light-dark-toggle--38:var(--csstools-color-scheme--light) #0D2224;
  --color-canvas:var(--csstools-light-dark-toggle--38, white);
  --background-color-canvas:var(--color-canvas);
  --csstools-light-dark-toggle--39:var(--csstools-color-scheme--light) #FFFFFF;
  --border-color-interactive:var(--csstools-light-dark-toggle--39, #555555);
...
@supports (color: light-dark(red, red)){
.toggle-button{
  --color-accent-primary:light-dark(#15B5B0, #3BBBC2);
  --color-accent-primary-hover:light-dark(#0D2224, #3BBBC2);
  --color-accent-primary-active:light-dark(#0D2224, #FFFFFF);
  --color-canvas:light-dark(white, #0D2224);
  --border-color-interactive:light-dark(#555555, #FFFFFF);
}
}
...
:root{
  ...
  --csstools-light-dark-toggle--40:var(--csstools-color-scheme--light) #0D2224;
  --signature-bg:var(--csstools-light-dark-toggle--40, #FFFFFF);
  --csstools-light-dark-toggle--41:var(--csstools-color-scheme--light) var(--signature-bg);
  --signature-hover-bg:var(--csstools-light-dark-toggle--41, #FFFFFF);
  --button-signature-bg:transparent;
  --button-signature-color:var(--main-color);
  --csstools-light-dark-toggle--42:var(--csstools-color-scheme--light) #555555;
  --button-signature-active-bg:var(--csstools-light-dark-toggle--42, #555555);
  --button-signature-active-border:none;
  --button-signature-active-color:var(--button-signature-color);
  --button-signature-border:none;
  --csstools-light-dark-toggle--43:var(--csstools-color-scheme--light) #555555;
  --button-signature-hover-bg:var(--csstools-light-dark-toggle--43, #FFFFFF);
  --button-signature-hover-color:var(--button-signature-color);
}

@supports (color: light-dark(red, red)){
:root{
  --signature-bg:light-dark(#FFFFFF, #0D2224);
  --signature-hover-bg:light-dark(#FFFFFF, var(--signature-bg));
  --button-signature-active-bg:light-dark(#555555, #555555);
  --button-signature-hover-bg:light-dark(#FFFFFF, #555555);
}
}
...
#3BBBC2SignatureDialog{
  --secondary-color:var(--text-secondary-color);
  --bg-hover:#FFFFFF;
  --tab-top-line-active-color:#15B5B0;
  --tab-top-line-active-hover-color:var(--tab-text-hover-color);
  --tab-top-line-hover-color:#555555;
  --tab-top-line-inactive-color:#555555;
  ...
  --clear-signature-button-bg-active:#555555;
  --clear-signature-button-bg-focus:#FFFFFF;
...
#3BBBC2SignatureDialog{
    --dialog-bg-color:#0D2224;
    --bg-hover:#555555;
    --primary-color:#FFFFFF;
    --secondary-color:#555555;
    --tab-top-line-active-color:#3BBBC2;
    --tab-top-line-inactive-color:#555555;
    --clear-signature-button-bg-active:#555555;
    --clear-signature-button-bg-focus:#0D2224;
    --clear-signature-button-bg-disabled:color-mix(
      in srgb,
      #0D2224,
      transparent 40%
...
#3BBBC2SignatureDialog #3BBBC2SignatureDialogLabel{
    overflow:hidden;
    position:absolute;
    inset:0;
    width:0;
...
#3BBBC2SignatureDialog.waiting::after{
    content:"";
    cursor:wait;
    position:absolute;
    inset:0;
...
:is(#3BBBC2SignatureDialog .mainContainer) [role="tablist"]{
      width:100%;
      display:flex;
      align-items:flex-start;
      gap:0;
...
:is(:is(#3BBBC2SignatureDialog .mainContainer) [role="tablist"])  > [role="tab"]{
        flex:1 0 0;
        align-self:stretch;
...
:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) [role="tablist"]) > [role="tab"]):hover{
...
:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) [role="tablist"]) > [role="tab"]):focus-visible{
          outline:2px solid var(--tab-top-line-active-color);
          outline-offset:-2px;
        }

[aria-selected="true"]:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) [role="tablist"]) > [role="tab"]){
          border-block-start-width:2px;
...
[aria-selected="true"]:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) [role="tablist"]) > [role="tab"]):hover{
            border-block-start-color:var(--tab-top-line-active-hover-color);
            background-color:var(--tab-bg-active-hover-color);
            color:var(--tab-text-active-hover-color);
          }

:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer{
      width:100%;
      height:auto;
      display:flex;
      flex-direction:column;
...
:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer)  > [role="tabpanel"]{
        position:relative;
        width:100%;
        height:220px;
...
:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) > [role="tabpanel"])  > svg{
          position:absolute;
          inset:0;
          width:100%;
          height:100%;
...
#3BBBC2SignatureTypeContainer:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) > [role="tabpanel"]){
          display:none;
        }

#3BBBC2SignatureTypeContainer:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) > [role="tabpanel"]) #3BBBC2SignatureTypeInput{
            position:absolute;
            inset:0;
            width:100%;
            height:100%;
...
:is(#3BBBC2SignatureTypeContainer:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) > [role="tabpanel"]) #3BBBC2SignatureTypeInput)::-moz-placeholder{
...
:is(#3BBBC2SignatureTypeContainer:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) > [role="tabpanel"]) #3BBBC2SignatureTypeInput)::placeholder{
              color:var(--signature-placeholder-color);
              text-align:center;
...
#3BBBC2SignatureDrawContainer:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) > [role="tabpanel"]){
          display:none;
        }

#3BBBC2SignatureDrawContainer:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) > [role="tabpanel"])  > span{
            position:absolute;
            top:0;
            left:0;
            width:100%;
...
#3BBBC2SignatureDrawContainer:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) > [role="tabpanel"])  > svg{
...
:is(#3BBBC2SignatureDrawContainer:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) > [role="tabpanel"]) > svg):hover{
              cursor:var(--draw-cursor);
            }

#3BBBC2SignatureDrawContainer:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) > [role="tabpanel"]) #thickness{
            position:absolute;
            width:100%;
            inset-block-end:0;
            display:grid;
...
:is(#3BBBC2SignatureDrawContainer:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) > [role="tabpanel"]) #thickness)  > span{
              color:var(--signature-draw-placeholder-color);
            }

:is(#3BBBC2SignatureDrawContainer:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) > [role="tabpanel"]) #thickness)  > div{
              width:auto;
              height:auto;
              display:flex;
              align-items:center;
...
:is(:is(#3BBBC2SignatureDrawContainer:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) > [role="tabpanel"]) #thickness) > div)  > label{
                color:var(--thickness-label-color);
              }

:is(:is(#3BBBC2SignatureDrawContainer:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) > [role="tabpanel"]) #thickness) > div)  > input{
                width:100px;
                height:14px;
                background-color:transparent;
              }

:is(:is(:is(#3BBBC2SignatureDrawContainer:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) > [role="tabpanel"]) #thickness) > div) > input)::-webkit-slider-runnable-track,:is(:is(:is(#3BBBC2SignatureDrawContainer:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) > [role="tabpanel"]) #thickness) > div) > input)::-moz-range-track,:is(:is(:is(#3BBBC2SignatureDrawContainer:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) > [role="tabpanel"]) #thickness) > div) > input)::-moz-range-progress{
                  background-color:var(--thickness-slider-color);
                }

:is(:is(:is(#3BBBC2SignatureDrawContainer:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) > [role="tabpanel"]) #thickness) > div) > input)::-webkit-slider-thumb,:is(:is(:is(#3BBBC2SignatureDrawContainer:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) > [role="tabpanel"]) #thickness) > div) > input)::-moz-range-thumb{
                  background-color:var(--thickness-bg);
                }
...
#3BBBC2SignatureImageContainer:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) > [role="tabpanel"]){
          display:none;
        }

#3BBBC2SignatureImageContainer:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) > [role="tabpanel"])  > svg{
            stroke:none;
            stroke-width:0;
...
#3BBBC2SignatureImageContainer:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) > [role="tabpanel"]) #3BBBC2SignatureImagePlaceholder{
            position:absolute;
            top:0;
            left:0;
            width:100%;
...
:is(#3BBBC2SignatureImageContainer:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) > [role="tabpanel"]) #3BBBC2SignatureImagePlaceholder) span{
              color:var(--signature-placeholder-color);
            }

:is(#3BBBC2SignatureImageContainer:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) > [role="tabpanel"]) #3BBBC2SignatureImagePlaceholder) a{
              color:var(--open-link-fg);
              text-decoration:underline;
              cursor:pointer;
            }

:is(:is(#3BBBC2SignatureImageContainer:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) > [role="tabpanel"]) #3BBBC2SignatureImagePlaceholder) a):hover{
                color:var(--open-link-hover-fg);
              }

#3BBBC2SignatureImageContainer:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) > [role="tabpanel"]) #3BBBC2SignatureFilePicker{
            visibility:hidden;
            position:relative;
            width:0;
            height:0;
...
[data-selected="type"]:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) > #3BBBC2SignatureTypeContainer,[data-selected="draw"]:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) > #3BBBC2SignatureDrawContainer,[data-selected="image"]:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) > #3BBBC2SignatureImageContainer{
        display:block;
      }

:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) #3BBBC2SignatureControls{
        display:flex;
        flex-direction:column;
        justify-content:center;
        align-items:flex-start;
...
:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) #3BBBC2SignatureControls) #horizontalContainer{
          display:flex;
          align-items:flex-end;
          gap:16px;
          align-self:stretch;
...
:is(:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) #3BBBC2SignatureControls) #horizontalContainer) #3BBBC2SignatureDescriptionContainer{
            display:flex;
            flex-direction:column;
            align-items:flex-start;
            gap:4px;
...
:is(:is(:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) #3BBBC2SignatureControls) #horizontalContainer) #3BBBC2SignatureDescriptionContainer):has(input:disabled) > label{
              opacity:0.4;
            }

:is(:is(:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) #3BBBC2SignatureControls) #horizontalContainer) #3BBBC2SignatureDescriptionContainer)  > label{
              width:auto;
            }

:is(:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) #3BBBC2SignatureControls) #horizontalContainer) #clearSignatureButton{
            display:flex;
            height:32px;
            padding:4px 8px;
            align-items:center;
...
:is(:is(:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) #3BBBC2SignatureControls) #horizontalContainer) #clearSignatureButton)  > span{
              display:flex;
              height:24px;
              align-items:center;
              gap:4px;
...
:is(:is(:is(:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) #3BBBC2SignatureControls) #horizontalContainer) #clearSignatureButton) > span)::after{
                content:"";
                display:inline-block;
                width:16px;
                height:16px;
...
:is(:is(:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) #3BBBC2SignatureControls) #horizontalContainer) #clearSignatureButton):hover{
              background-color:var(--clear-signature-button-bg-hover);
            }

:is(:is(:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) #3BBBC2SignatureControls) #horizontalContainer) #clearSignatureButton):hover  > span{
                color:var(--clear-signature-button-hover-color);
              }

:is(:is(:is(:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) #3BBBC2SignatureControls) #horizontalContainer) #clearSignatureButton):hover > span)::after{
                  background-color:var(--clear-signature-button-hover-color);
                }

:is(:is(:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) #3BBBC2SignatureControls) #horizontalContainer) #clearSignatureButton):active{
              background-color:var(--clear-signature-button-bg-active);
            }

:is(:is(:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) #3BBBC2SignatureControls) #horizontalContainer) #clearSignatureButton):active  > span{
                color:var(--clear-signature-button-active-color);
              }

:is(:is(:is(:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) #3BBBC2SignatureControls) #horizontalContainer) #clearSignatureButton):active > span)::after{
                  background-color:var(--clear-signature-button-active-color);
                }

:is(:is(:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) #3BBBC2SignatureControls) #horizontalContainer) #clearSignatureButton):focus-visible{
              background-color:var(--clear-signature-button-bg-focus);
            }

:is(:is(:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) #3BBBC2SignatureControls) #horizontalContainer) #clearSignatureButton):focus-visible  > span{
                color:var(--clear-signature-button-focus-color);
              }

:is(:is(:is(:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) #3BBBC2SignatureControls) #horizontalContainer) #clearSignatureButton):focus-visible > span)::after{
                  background-color:var(--clear-signature-button-focus-color);
                }

:is(:is(:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) #3BBBC2SignatureControls) #horizontalContainer) #clearSignatureButton):disabled{
              background-color:var(--clear-signature-button-bg-disabled);
              border-color:var(--clear-signature-button-border-disabled-color);
            }

:is(:is(:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) #3BBBC2SignatureControls) #horizontalContainer) #clearSignatureButton):disabled  > span{
                color:var(--clear-signature-button-disabled-color);
              }

:is(:is(:is(:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) #3BBBC2SignatureControls) #horizontalContainer) #clearSignatureButton):disabled > span)::after{
                  background-color:var(
                    --clear-signature-button-disabled-color
                  );
                }

:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) #3BBBC2SignatureControls) #3BBBC2SignatureSaveContainer{
          display:grid;
...
:is(:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) #3BBBC2SignatureControls) #3BBBC2SignatureSaveContainer)  > input{
            margin:0;
          }

:is(:is(:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) #3BBBC2SignatureControls) #3BBBC2SignatureSaveContainer) > input):disabled + label{
              opacity:0.4;
            }

:is(:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) #3BBBC2SignatureControls) #3BBBC2SignatureSaveContainer)  > label{
            -webkit-user-select:none;
               -moz-user-select:none;
                    user-select:none;
          }

:is(:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) #3BBBC2SignatureControls) #3BBBC2SignatureSaveContainer):not(.fullStorage) #3BBBC2SignatureSaveWarning{
            display:none;
          }

.fullStorage:is(:is(:is(:is(#3BBBC2SignatureDialog .mainContainer) #3BBBC2SignatureActionContainer) #3BBBC2SignatureControls) #3BBBC2SignatureSaveContainer) #3BBBC2SignatureSaveWarning{
            display:block;
            opacity:1;
...
#editorSignatureParamsToolbar #3BBBC2SignatureDoorHanger{
    gap:8px;
    padding:2px;
  }

:is(#editorSignatureParamsToolbar #3BBBC2SignatureDoorHanger) .toolbarAddSignatureButtonContainer{
      height:32px;
      display:flex;
...
:is(:is(#editorSignatureParamsToolbar #3BBBC2SignatureDoorHanger) .toolbarAddSignatureButtonContainer) button{
...
:is(:is(:is(#editorSignatureParamsToolbar #3BBBC2SignatureDoorHanger) .toolbarAddSignatureButtonContainer) button):hover{
          background-color:var(--button-signature-hover-bg);
        }

:is(:is(:is(#editorSignatureParamsToolbar #3BBBC2SignatureDoorHanger) .toolbarAddSignatureButtonContainer) button):active{
          border:var(--button-signature-active-border);
          background-color:var(--button-signature-active-bg);
          color:var(--button-signature-active-color);
        }

:is(:is(:is(#editorSignatureParamsToolbar #3BBBC2SignatureDoorHanger) .toolbarAddSignatureButtonContainer) button):active::before{
            background-color:var(--button-signature-active-color);
          }

:is(:is(:is(#editorSignatureParamsToolbar #3BBBC2SignatureDoorHanger) .toolbarAddSignatureButtonContainer) button):focus-visible{
          outline:var(--focus-ring-outline);
        }

:is(:is(:is(#editorSignatureParamsToolbar #3BBBC2SignatureDoorHanger) .toolbarAddSignatureButtonContainer) button):focus-visible::before{
            background-color:var(--button-signature-color);
          }

:is(:is(:is(#editorSignatureParamsToolbar #3BBBC2SignatureDoorHanger) .toolbarAddSignatureButtonContainer) .deleteButton)::before{
          -webkit-mask-image:var(--clear-signature-button-icon);
                  mask-image:var(--clear-signature-button-icon);
        }

:is(:is(#editorSignatureParamsToolbar #3BBBC2SignatureDoorHanger) .toolbarAddSignatureButtonContainer) .toolbarAddSignatureButton{
...
:is(:is(:is(#editorSignatureParamsToolbar #3BBBC2SignatureDoorHanger) .toolbarAddSignatureButtonContainer) .toolbarAddSignatureButton)  > svg{
          display:inline-block;
          height:100%;
          aspect-ratio:1;
          background-color:var(--signature-bg);
...
:is(:is(:is(:is(#editorSignatureParamsToolbar #3BBBC2SignatureDoorHanger) .toolbarAddSignatureButtonContainer) .toolbarAddSignatureButton) > svg)  > path{
            stroke:var(--button-signature-color);
            stroke-width:1px;
            stroke-linecap:round;
            stroke-linejoin:round;
...
.contours:is(:is(:is(:is(:is(#editorSignatureParamsToolbar #3BBBC2SignatureDoorHanger) .toolbarAddSignatureButtonContainer) .toolbarAddSignatureButton) > svg) > path){
              fill:var(--button-signature-color);
              stroke-width:0.5px;
            }

:is(:is(:is(#editorSignatureParamsToolbar #3BBBC2SignatureDoorHanger) .toolbarAddSignatureButtonContainer) .toolbarAddSignatureButton):is(:hover,:active) > svg{
          border-radius:4px 0 0 4px;
          background-color:var(--signature-hover-bg);
        }

:is(:is(:is(#editorSignatureParamsToolbar #3BBBC2SignatureDoorHanger) .toolbarAddSignatureButtonContainer) .toolbarAddSignatureButton):hover  > span{
            color:var(--button-signature-hover-color);
          }

:is(:is(:is(#editorSignatureParamsToolbar #3BBBC2SignatureDoorHanger) .toolbarAddSignatureButtonContainer) .toolbarAddSignatureButton):active{
          background-color:var(--button-signature-active-bg);
        }

:is(:is(:is(#editorSignatureParamsToolbar #3BBBC2SignatureDoorHanger) .toolbarAddSignatureButtonContainer) .toolbarAddSignatureButton):is([disabled="disabled"],[disabled]){
          opacity:0.5;
          pointer-events:none;
        }

:is(:is(:is(#editorSignatureParamsToolbar #3BBBC2SignatureDoorHanger) .toolbarAddSignatureButtonContainer) .toolbarAddSignatureButton)  > span{
          height:auto;
...
:is(.annotationLayer,.annotationEditorLayer) .annotationCommentButton{
    ...
    --csstools-light-dark-toggle--44:var(--csstools-color-scheme--light) #0D2224;
    --comment-button-bg:var(--csstools-light-dark-toggle--44, white);
    --csstools-light-dark-toggle--45:var(--csstools-color-scheme--light) #FFFFFF;
    --comment-button-fg:var(--csstools-light-dark-toggle--45, #555555);
    --csstools-light-dark-toggle--46:var(--csstools-color-scheme--light) #FFFFFF;
    --comment-button-active-bg:var(--csstools-light-dark-toggle--46, #0D2224);
    --csstools-light-dark-toggle--47:var(--csstools-color-scheme--light) #0D2224;
    --comment-button-active-fg:var(--csstools-light-dark-toggle--47, white);
    --csstools-light-dark-toggle--48:var(--csstools-color-scheme--light) #3BBBC2;
    --comment-button-hover-bg:var(--csstools-light-dark-toggle--48, #15B5B0);
    --csstools-light-dark-toggle--49:var(--csstools-color-scheme--light) #0D2224;
    --comment-button-hover-fg:var(--csstools-light-dark-toggle--49, white);
    --csstools-light-dark-toggle--50:var(--csstools-color-scheme--light) #3BBBC2;
    --comment-button-selected-bg:var(--csstools-light-dark-toggle--50, #15B5B0);
    --csstools-light-dark-toggle--51:var(--csstools-color-scheme--light) #555555;
    --comment-button-border-color:var(--csstools-light-dark-toggle--51, #555555);
    --comment-button-active-border-color:var(--comment-button-active-bg);
    --csstools-light-dark-toggle--52:var(--csstools-color-scheme--light) #0D2224;
    --comment-button-focus-border-color:var(--csstools-light-dark-toggle--52, #555555);
    ...
    --csstools-light-dark-toggle--53:var(--csstools-color-scheme--light) #0D2224;
    ...
    --csstools-light-dark-toggle--56:var(--csstools-color-scheme--light) #3BBBC2;
    --comment-button-focus-outline-color:var(--csstools-light-dark-toggle--56, #15B5B0);
  }

@supports (color: light-dark(red, red)){
:is(.annotationLayer,.annotationEditorLayer) .annotationCommentButton{
    --comment-button-bg:light-dark(white, #0D2224);
    --comment-button-fg:light-dark(#555555, #FFFFFF);
    --comment-button-active-bg:light-dark(#0D2224, #FFFFFF);
    --comment-button-active-fg:light-dark(white, #0D2224);
    --comment-button-hover-bg:light-dark(#15B5B0, #3BBBC2);
    --comment-button-hover-fg:light-dark(white, #0D2224);
    --comment-button-selected-bg:light-dark(#15B5B0, #3BBBC2);
    --comment-button-border-color:light-dark(#555555, #555555);
    --comment-button-focus-border-color:light-dark(#555555, #0D2224);
    --comment-button-selected-fg:light-dark(white, #0D2224);
  }
}
...
@supports (color: light-dark(red, red)){
:is(.annotationLayer,.annotationEditorLayer) .annotationCommentButton{
    --comment-button-focus-outline-color:light-dark(#15B5B0, #3BBBC2);
  }
}
...
.commentPopup{
  ...
  --csstools-light-dark-toggle--58:var(--csstools-color-scheme--light) #0D2224;
  --comment-bg-color:var(--csstools-light-dark-toggle--58, #FFFFFF);
  --csstools-light-dark-toggle--59:var(--csstools-color-scheme--light) #0D2224;
  --comment-hover-bg-color:var(--csstools-light-dark-toggle--59, #FFFFFF);
  --csstools-light-dark-toggle--60:var(--csstools-color-scheme--light) #0D2224;
  --comment-active-bg-color:var(--csstools-light-dark-toggle--60, #555555);
  ...
  --csstools-light-dark-toggle--61:var(--csstools-color-scheme--light) #555555;
  --comment-border-color:var(--csstools-light-dark-toggle--61, #FFFFFF);
  --csstools-light-dark-toggle--62:var(--csstools-color-scheme--light) #3BBBC2;
  --comment-focus-outline-color:var(--csstools-light-dark-toggle--62, #15B5B0);
  --csstools-light-dark-toggle--63:var(--csstools-color-scheme--light) #FFFFFF;
  --comment-fg-color:var(--csstools-light-dark-toggle--63, #0D2224);
  --csstools-light-dark-toggle--64:var(--csstools-color-scheme--light) #0D2224;
  --comment-count-bg-color:var(--csstools-light-dark-toggle--64, #FFFFFF);
  --csstools-light-dark-toggle--65:var(--csstools-color-scheme--light) #FFFFFF;
  --comment-indicator-active-fg-color:var(--csstools-light-dark-toggle--65, #0D2224);
  --comment-indicator-active-filter:brightness(
    calc(1 / var(--comment-active-brightness))
  );
  --csstools-light-dark-toggle--66:var(--csstools-color-scheme--light) #FFFFFF;
  --comment-indicator-focus-fg-color:var(--csstools-light-dark-toggle--66, #555555);
  --csstools-light-dark-toggle--67:var(--csstools-color-scheme--light) #3BBBC2;
  --comment-indicator-hover-fg-color:var(--csstools-light-dark-toggle--67, #15B5B0);
  --comment-indicator-hover-filter:brightness(
    calc(1 / var(--comment-hover-brightness))
  );
  --csstools-light-dark-toggle--68:var(--csstools-color-scheme--light) #3BBBC2;
  --comment-indicator-selected-fg-color:var(--csstools-light-dark-toggle--68, #15B5B0);

  --button-comment-bg:transparent;
  --button-comment-color:var(--main-color);
  --csstools-light-dark-toggle--69:var(--csstools-color-scheme--light) #555555;
  --button-comment-active-bg:var(--csstools-light-dark-toggle--69, #555555);
  --button-comment-active-border:none;
  --button-comment-active-color:var(--button-comment-color);
  --button-comment-border:none;
  --csstools-light-dark-toggle--70:var(--csstools-color-scheme--light) #555555;
  --button-comment-hover-bg:var(--csstools-light-dark-toggle--70, #FFFFFF);
  --button-comment-hover-color:var(--button-comment-color);

  --csstools-light-dark-toggle--71:var(--csstools-color-scheme--light) #3BBBC2;

  --link-fg-color:var(--csstools-light-dark-toggle--71, #15B5B0);
  --csstools-light-dark-toggle--72:var(--csstools-color-scheme--light) #3BBBC2;
  --link-hover-fg-color:var(--csstools-light-dark-toggle--72, #0D2224);
}
...
#editorCommentsSidebar,
.commentPopup{
  --comment-bg-color:light-dark(#FFFFFF, #0D2224);
  --comment-hover-bg-color:light-dark(#FFFFFF, #0D2224);
  --comment-active-bg-color:light-dark(#555555, #0D2224);
  --comment-border-color:light-dark(#FFFFFF, #555555);
  --comment-focus-outline-color:light-dark(#15B5B0, #3BBBC2);
  --comment-fg-color:light-dark(#0D2224, #FFFFFF);
  --comment-count-bg-color:light-dark(#FFFFFF, #0D2224);
  --comment-indicator-active-fg-color:light-dark(#0D2224, #FFFFFF);
  --comment-indicator-focus-fg-color:light-dark(#555555, #FFFFFF);
  --comment-indicator-hover-fg-color:light-dark(#15B5B0, #3BBBC2);
  --comment-indicator-selected-fg-color:light-dark(#15B5B0, #3BBBC2);
  --button-comment-active-bg:light-dark(#555555, #555555);
  --button-comment-hover-bg:light-dark(#FFFFFF, #555555);
...
.commentPopup{
  ...
  --csstools-light-dark-toggle--73:var(--csstools-color-scheme--light) #0D2224;

  --divider-color:var(--csstools-light-dark-toggle--73, #555555);
...
.commentPopup{
  ...
  --divider-color:light-dark(#555555, #0D2224);
}
}
...
:root{
  ...
  --outline-width:2px;
  --outline-color:#15B5B0;
  --outline-around-width:1px;
  --outline-around-color:#FFFFFF;
...
:is(.annotationEditorLayer :is(.freeTextEditor,.inkEditor,.stampEditor,.highlightEditor,.signatureEditor),.textLayer) .editToolbar{
    ...
    --csstools-light-dark-toggle--76:var(--csstools-color-scheme--light) #0D2224;
    --editor-toolbar-bg-color:var(--csstools-light-dark-toggle--76, #FFFFFF);
    --editor-toolbar-highlight-image:url(images/toolbarButton-editorHighlight.svg);
    --csstools-light-dark-toggle--77:var(--csstools-color-scheme--light) #FFFFFF;
    --editor-toolbar-fg-color:var(--csstools-light-dark-toggle--77, #0D2224);
    --editor-toolbar-border-color:#555555;
    --editor-toolbar-hover-border-color:var(--editor-toolbar-border-color);
    --csstools-light-dark-toggle--78:var(--csstools-color-scheme--light) #555555;
    --editor-toolbar-hover-bg-color:var(--csstools-light-dark-toggle--78, #FFFFFF);
    --editor-toolbar-hover-fg-color:var(--editor-toolbar-fg-color);
    --editor-toolbar-hover-outline:none;
    --csstools-light-dark-toggle--79:var(--csstools-color-scheme--light) #3BBBC2;
    --editor-toolbar-focus-outline-color:var(--csstools-light-dark-toggle--79, #15B5B0);
    --editor-toolbar-shadow:0 2px 6px 0 rgb(58 57 68 / 0.2);
    --editor-toolbar-height:28px;
    --editor-toolbar-padding:2px;
    --csstools-light-dark-toggle--80:var(--csstools-color-scheme--light) #3BBBC2;
    --alt-text-done-color:var(--csstools-light-dark-toggle--80, #3BBBC2);
    --csstools-light-dark-toggle--81:var(--csstools-color-scheme--light) #3BBBC2;
    --alt-text-warning-color:var(--csstools-light-dark-toggle--81, #15B5B0);
...
@supports (color: light-dark(red, red)){
:is(.annotationEditorLayer :is(.freeTextEditor,.inkEditor,.stampEditor,.highlightEditor,.signatureEditor),.textLayer) .editToolbar{
    --editor-toolbar-bg-color:light-dark(#FFFFFF, #0D2224);
    --editor-toolbar-fg-color:light-dark(#0D2224, #FFFFFF);
    --editor-toolbar-hover-bg-color:light-dark(#FFFFFF, #555555);
    --editor-toolbar-focus-outline-color:light-dark(#15B5B0, #3BBBC2);
    --alt-text-done-color:light-dark(#3BBBC2, #3BBBC2);
    --alt-text-warning-color:light-dark(#15B5B0, #3BBBC2);
  }
}
...
.show:is(:is(:is(:is(:is(.annotationEditorLayer :is(.freeTextEditor,.inkEditor,.stampEditor,.highlightEditor,.signatureEditor),.textLayer) .editToolbar) .buttons) .altText) .tooltip){
            --csstools-light-dark-toggle--82:var(--csstools-color-scheme--light) #0D2224;
            --alt-text-tooltip-bg:var(--csstools-light-dark-toggle--82, #FFFFFF);
            --csstools-light-dark-toggle--83:var(--csstools-color-scheme--light) #FFFFFF;
            --alt-text-tooltip-fg:var(--csstools-light-dark-toggle--83, #0D2224);
            --alt-text-tooltip-border:#555555;
            --csstools-light-dark-toggle--84:var(--csstools-color-scheme--light) #0D2224;
            --alt-text-tooltip-shadow:0 2px 6px 0 var(--csstools-light-dark-toggle--84, rgb(58 57 68 / 0.2));
          }

@supports (color: light-dark(red, red)){
.show:is(:is(:is(:is(:is(.annotationEditorLayer :is(.freeTextEditor,.inkEditor,.stampEditor,.highlightEditor,.signatureEditor),.textLayer) .editToolbar) .buttons) .altText) .tooltip){
            --alt-text-tooltip-bg:light-dark(#FFFFFF, #0D2224);
            --alt-text-tooltip-fg:light-dark(#0D2224, #FFFFFF);
          }
}

@supports (color: light-dark(red, red)) and (color: rgb(0 0 0 / 0)){
.show:is(:is(:is(:is(:is(.annotationEditorLayer :is(.freeTextEditor,.inkEditor,.stampEditor,.highlightEditor,.signatureEditor),.textLayer) .editToolbar) .buttons) .altText) .tooltip){
            --alt-text-tooltip-shadow:0 2px 6px 0 light-dark(rgb(58 57 68 / 0.2), #0D2224);
          }
}
...
:is(.annotationEditorLayer .stampEditor) .noAltTextBadge{
    --csstools-light-dark-toggle--85:var(--csstools-color-scheme--light) #555555;
    --no-alt-text-badge-border-color:var(--csstools-light-dark-toggle--85, #FFFFFF);
    --csstools-light-dark-toggle--86:var(--csstools-color-scheme--light) #FFFFFF;
    --no-alt-text-badge-bg-color:var(--csstools-light-dark-toggle--86, #555555);
    --csstools-light-dark-toggle--87:var(--csstools-color-scheme--light) #0D2224;
    --no-alt-text-badge-fg-color:var(--csstools-light-dark-toggle--87, #555555);
  }

@supports (color: light-dark(red, red)){
:is(.annotationEditorLayer .stampEditor) .noAltTextBadge{
    --no-alt-text-badge-border-color:light-dark(#FFFFFF, #555555);
    --no-alt-text-badge-bg-color:light-dark(#555555, #FFFFFF);
    --no-alt-text-badge-fg-color:light-dark(#555555, #0D2224);
  }
}
...
.dialog.newAltText{
  ...
  --csstools-light-dark-toggle--88:var(--csstools-color-scheme--light) #0D2224;
  --preview-image-bg-color:var(--csstools-light-dark-toggle--88, #FFFFFF);
  --preview-image-border:none;
}

@supports (color: light-dark(red, red)){
.dialog.newAltText{
  --preview-image-bg-color:light-dark(#FFFFFF, #0D2224);
}
}
...
.colorPicker{
  --csstools-light-dark-toggle--89:var(--csstools-color-scheme--light) #3BBBC2;
  --hover-outline-color:var(--csstools-light-dark-toggle--89, #0D2224);
  --csstools-light-dark-toggle--90:var(--csstools-color-scheme--light) #FFFFFF;
  --selected-outline-color:var(--csstools-light-dark-toggle--90, #15B5B0);
  --csstools-light-dark-toggle--91:var(--csstools-color-scheme--light) #555555;
  --swatch-border-color:var(--csstools-light-dark-toggle--91, #555555);
}

@supports (color: light-dark(red, red)){
.colorPicker{
  --hover-outline-color:light-dark(#0D2224, #3BBBC2);
  --selected-outline-color:light-dark(#15B5B0, #FFFFFF);
  --swatch-border-color:light-dark(#555555, #555555);
}
}
...
:is(#highlightParamsToolbarContainer #editorHighlightThickness) .thicknessPicker{
      ...
      --csstools-light-dark-toggle--92:var(--csstools-color-scheme--light) #555555;

      --example-color:var(--csstools-light-dark-toggle--92, #555555);
    }

@supports (color: light-dark(red, red)){
:is(#highlightParamsToolbarContainer #editorHighlightThickness) .thicknessPicker{

      --example-color:light-dark(#555555, #555555);
    }
}
...
:is(#highlightParamsToolbarContainer #editorHighlightVisibility) .divider{
      --csstools-light-dark-toggle--93:var(--csstools-color-scheme--light) #555555;
      --divider-color:var(--csstools-light-dark-toggle--93, #555555);
    }

@supports (color: light-dark(red, red)){
:is(#highlightParamsToolbarContainer #editorHighlightVisibility) .divider{
      --divider-color:light-dark(#555555, #555555);
    }
}
...
.popupMenu{
  ...
  --csstools-light-dark-toggle--94:var(--csstools-color-scheme--light) #3BBBC2;
  --menuitem-focus-outline-color:var(--csstools-light-dark-toggle--94, #15B5B0);
  ...
  --csstools-light-dark-toggle--96:var(--csstools-color-scheme--light) #0D2224;
  ...
  --csstools-light-dark-toggle--100:var(--csstools-color-scheme--light) #FFFFFF;
  --menu-text-color:var(--csstools-light-dark-toggle--100, #0D2224);
...
@supports (color: light-dark(red, red)){
.popupMenu{
  --menuitem-focus-outline-color:light-dark(#15B5B0, #3BBBC2);
  --menuitem-focus-border-color:light-dark(white, black);

  --menu-bg:light-dark(white, #0D2224);
}
}
...
@supports (color: light-dark(red, red)){
.popupMenu{
  --menu-text-color:light-dark(#0D2224, #FFFFFF);
}
}
...
#viewsManager{
  ...
  --csstools-light-dark-toggle--107:var(--csstools-color-scheme--light) #FFFFFF;

  --text-color:var(--csstools-light-dark-toggle--107, #0D2224);
  ...
  --csstools-light-dark-toggle--111:var(--csstools-color-scheme--light) #3BBBC2;
  --button-focus-outline-color:var(--csstools-light-dark-toggle--111, #15B5B0);
  ...
  --csstools-light-dark-toggle--115:var(--csstools-color-scheme--light) #3BBBC2;
  --indicator-color:var(--csstools-light-dark-toggle--115, #15B5B0);
  --csstools-light-dark-toggle--116:var(--csstools-color-scheme--light) #0D2224;
  --status-warning-bg:var(--csstools-light-dark-toggle--116, #FFFFFF);
  --csstools-light-dark-toggle--117:var(--csstools-color-scheme--light) #3BBBC2;
  --indicator-warning-color:var(--csstools-light-dark-toggle--117, #0D2224);
  ...
  --csstools-light-dark-toggle--120:var(--csstools-color-scheme--light) #0D2224;
  --header-bg:var(--csstools-light-dark-toggle--120, rgb(255 255 255 / 0.92));
  --image-outline:none;
  --image-border-width:6px;
  --csstools-light-dark-toggle--121:var(--csstools-color-scheme--light) #0D2224;
  --image-border-color:var(--csstools-light-dark-toggle--121, #555555);
  --image-hover-border-color:#555555;
  ...
  --csstools-light-dark-toggle--122:var(--csstools-color-scheme--light) #0D2224;
  --image-page-number-bg:var(--csstools-light-dark-toggle--122, #FFFFFF);
  ...
  --csstools-light-dark-toggle--123:var(--csstools-color-scheme--light) #0D2224;
  --image-current-page-number-fg:var(--csstools-light-dark-toggle--123, #FFFFFF);
  ...
  --csstools-light-dark-toggle--132:var(--csstools-color-scheme--light) #0D2224;
  --multiple-dragging-text-color:var(--csstools-light-dark-toggle--132, #FFFFFF);
}
...
#viewsManager{
  ...
  --text-color:light-dark(#0D2224, #FFFFFF);
}
}
...
@supports (color: light-dark(red, red)){
#viewsManager{
  --button-focus-outline-color:light-dark(#15B5B0, #3BBBC2);
...
@supports (color: light-dark(red, red)){
#viewsManager{
  --indicator-color:light-dark(#15B5B0, #3BBBC2);
  --status-warning-bg:light-dark(#FFFFFF, #0D2224);
  --indicator-warning-color:light-dark(#0D2224, #3BBBC2);
}
}
...
#viewsManager{
  ...
  --header-bg:light-dark(rgb(255 255 255 / 0.92), #0D2224);
}
}

@supports (color: light-dark(red, red)){
#viewsManager{
  --image-border-color:light-dark(#555555, #0D2224);
  --image-page-number-bg:light-dark(#FFFFFF, #0D2224);
  --image-current-page-number-fg:light-dark(#FFFFFF, #0D2224);
}
}
...
@supports (color: light-dark(red, red)){
#viewsManager{
  --multiple-dragging-text-color:light-dark(#FFFFFF, #0D2224);
}
}
...
.sidebar{
  --csstools-light-dark-toggle--136:var(--csstools-color-scheme--light) #0D2224;
  --sidebar-bg-color:var(--csstools-light-dark-toggle--136, #FFFFFF);
  ...
  --csstools-light-dark-toggle--140:var(--csstools-color-scheme--light) #3BBBC2;
  --resizer-hover-bg-color:var(--csstools-light-dark-toggle--140, #15B5B0);
}

@supports (color: light-dark(red, red)){
.sidebar{
  --sidebar-bg-color:light-dark(#FFFFFF, #0D2224);
}
}
...
@supports (color: light-dark(red, red)){
.sidebar{
  --resizer-hover-bg-color:light-dark(#15B5B0, #3BBBC2);
}
}
...
:root{
  ...
  --csstools-light-dark-toggle--141:var(--csstools-color-scheme--light) #3BBBC2;
  --focus-ring-color:var(--csstools-light-dark-toggle--141, #15B5B0);
  --focus-ring-outline:2px solid var(--focus-ring-color);
  --csstools-light-dark-toggle--142:var(--csstools-color-scheme--light) #3BBBC2;
  --new-badge-bg:var(--csstools-light-dark-toggle--142, #15B5B0);
  --csstools-light-dark-toggle--143:var(--csstools-color-scheme--light) #0D2224;
  --new-badge-color:var(--csstools-light-dark-toggle--143, #FFFFFF);
  --new-badge-border-color:light-dark(#FFFFFF / 40%, #0D2224 / 40%);
}

@supports (color: light-dark(red, red)){
:root{
  --focus-ring-color:light-dark(#15B5B0, #3BBBC2);
  --new-badge-bg:light-dark(#15B5B0, #3BBBC2);
  --new-badge-color:light-dark(#FFFFFF, #0D2224);
}
}
